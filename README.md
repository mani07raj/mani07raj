...
### 🚀 Builder • 🤖 AI Explorer • 🧪 Automation Engineer

</div>

- 🎓 CS Student from **India 🇮🇳**
- 🤖 Building **AI-powered real-world systems**
- 🧪 Focused on **QA Automation & Testing Frameworks**
- 🌐 Developing **scalable web & backend solutions**
- 📊 Exploring **Data Analytics & Intelligence**
- ⚡ Obsessed with **clean, efficient, production-ready code**
...
- 🧠 Exploring **advanced automation frameworks**
- 💬 Ask me about **Java, Python, SQL, Selenium**
- ☕ Debugging runs on **coffee + curiosity**
...
> 🏥 **Multimodal AI Agent**  
> Voice + Vision + Real-Time AI Diagnosis using STT, TTS & low-latency pipelines.
